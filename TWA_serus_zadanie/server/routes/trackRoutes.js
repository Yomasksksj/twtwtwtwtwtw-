...
router.get('/skladba/nazov/:name', authenticate, trackController.getByName);
router.get('/skladba/interpret/:name/:firstName/:lastName', authenticate, trackController.getByNameAndArtist);
